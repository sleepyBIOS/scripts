...
local RadioFrame = Instance.new("ScrollingFrame")
local UIListLayout_2 = Instance.new("UIListLayout")
local Chat_2 = Instance.new("TextLabel")
local Chat_3 = Instance.new("TextLabel")

--Properties:

ChatLog.Name = "ChatLog"
ChatLog.Parent = game.CoreGui
ChatLog.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
ChatLog.ResetOnSpawn = false

Top.Name = "Top"
Top.Parent = ChatLog
Top.BackgroundColor3 = Color3.fromRGB(58, 58, 58)
Top.BorderColor3 = Color3.fromRGB(0, 0, 0)
Top.BorderSizePixel = 0
Top.Position = UDim2.new(0.338403046, -205, 0.297738701, -70)
Top.Size = UDim2.new(0, 462, 0, 24)
Top.Draggable = true
...
Title.Position = UDim2.new(0.134199128, 0, 0, 0)
Title.Size = UDim2.new(0, 338, 0, 24)
Title.Font = Enum.Font.SourceSans
Title.Text = "SCP Site 19 Chatlog by @whiz.sk"
Title.TextColor3 = Color3.fromRGB(255, 255, 255)
Title.TextSize = 14.000

Minimize.Name = "Minimize"
Minimize.Parent = Top
Minimize.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
Minimize.BorderColor3 = Color3.fromRGB(0, 0, 0)
Minimize.BorderSizePixel = 0
Minimize.Position = UDim2.new(0.947331786, 0, 0, 0)
...
Main.Size = UDim2.new(0, 462, 0, 233)

World.Name = "World"
World.Parent = Main
World.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
World.BorderColor3 = Color3.fromRGB(0, 0, 0)
World.BorderSizePixel = 0
World.Position = UDim2.new(0.0209248867, 0, 0.875536501, 0)
World.Size = UDim2.new(0, 97, 0, 22)
...
Radio.Name = "Radio"
Radio.Parent = Main
Radio.BackgroundColor3 = Color3.fromRGB(74, 74, 74)
Radio.BorderColor3 = Color3.fromRGB(0, 0, 0)
Radio.BorderSizePixel = 0
Radio.Position = UDim2.new(0.252526611, 0, 0.875536501, 0)
Radio.Size = UDim2.new(0, 97, 0, 22)
Radio.Font = Enum.Font.SourceSans
Radio.Text = "Radio"
...
WorldFrame.BackgroundColor3 = Color3.fromRGB(58, 58, 58)
WorldFrame.BorderColor3 = Color3.fromRGB(0, 0, 0)
WorldFrame.BorderSizePixel = 0
WorldFrame.Position = UDim2.new(0.0303030312, 0, 0.0343347639, 0)
WorldFrame.Size = UDim2.new(0, 433, 0, 185)

UIListLayout.Parent = WorldFrame
...
Chat.Size = UDim2.new(0, 433, 0, 21)
...
local function message(plr : Player, msg : string?)
	--print("message said")
	local textLabel = Chat:Clone()
	textLabel.Visible = true
	if msg:sub(1, 3) == "/e " then
		textLabel.Parent = RadioFrame
		textLabel.Text = "[" .. plr.Name .. "]: " .. msg
	else
...
local function updateInput(input)
	...
	game:GetService('TweenService'):Create(Top, TweenInfo.new(dragSpeed), {Position = position}):Play()
end
